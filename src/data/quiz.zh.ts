...
export const QUIZ: QuizQuestion[] = [
  {
    ...
    options: ["萨瓦·莫罗佐夫", "帕维尔·特列季亚科夫", "谢尔盖·舒金", "阿列克谢·巴赫鲁申"],
    correct: 1,
    explain:
      "帕维尔·米哈伊洛维奇·特列季亚科夫于1856年开始收藏俄罗斯画作，并于1892年将藏品捐赠给莫斯科。",
    link: { to: "/litsa#person-tretyakov", label: "帕维尔·特列季亚科夫" },
  },
  {
    kind: "single",
    id: "azbuka-mecenat",
  ...
  },
  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/8/85/Ivan_Shuvalov_by_F.Rokotov_%281760%2C_Hermitage%29.jpg",
    imageAlt: "18世纪赞助人的肖像",
    options: ["伊万·别茨科伊", "尼古拉·鲁缅采夫", "伊万·舒瓦洛夫", "亚历山大·斯特罗加诺夫"],
    correct: 2,
    explain:
      "1755年，伊万·舒瓦洛夫与米哈伊尔·瓦西里耶维奇·罗蒙诺索夫共同创立了莫斯科大学，并于1757年创立了艺术学院。",
  ...
  },
  {
    ...
    correct: 1,
    explain: "伊丽莎白·彼得罗芙娜女皇关于建立莫斯科大学的法令于1755年签署。",
    link: { to: "/nasledie#legacy-msu", label: "遗产 — 莫斯科大学" },
  },
  {
    kind: "multi",
    id: "morozovs",
    question: "以下哪些人属于莫罗佐夫家族的赞助人和企业家？",
    options: [
      "萨瓦·莫罗佐夫",
      "瓦尔瓦拉·莫罗佐娃",
      "伊万·莫罗佐夫",
    ...
    correct: [0, 1, 2, 4],
    explain:
      "萨瓦、瓦尔瓦拉、伊万和玛加丽塔是著名的莫罗佐夫商人王朝的代表。巴赫鲁申来自另一个莫斯科商人家族，而帕夫利克·莫罗佐夫是苏联时期的先锋，与该王朝无关。",
  ...
  },
  {
    ...
    options: ["穆萨·纳吉耶夫", "伊曼纽尔·诺贝尔", "哈吉·塔吉耶夫", "阿方斯·沙尼亚夫斯基"],
    correct: 2,
    explain: "哈吉·宰纳拉布丁·塔吉耶夫资助了肖拉尔输水管道的建设——这是巴库最大的工程项目之一。",
    link: { to: "/litsa#person-tagiev", label: "哈吉·塔吉耶夫" },
  },
  {
    kind: "single",
    id: "rumyantsev",
    question: "谁的藏书和手稿构成了俄罗斯国家图书馆的基础？",
    options: ["尼古拉·鲁缅采夫", "科兹马·索尔达滕科夫", "伊万·舒瓦洛夫", "尼古拉·尤苏波夫"],
    correct: 0,
    explain: "尼古拉·鲁缅采夫伯爵将他的藏书和手稿遗赠给国家——这是未来俄罗斯国家图书馆的基础。",
    link: { to: "/litsa#person-rumyantsev", label: "尼古拉·鲁缅采夫" },
  },
  {
    kind: "single",
    id: "era-1861",
  ...
  },
  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/8/82/Ilja_Jefimowitsch_Repin_-_Portrait_of_Pavel_Mikha%C3%AFlovitch_Tr%C3%A9tiakov.jpg",
    imageAlt: "伊利亚·列宾的肖像",
    options: ["谢尔盖·舒金", "帕维尔·特列季亚科夫", "萨瓦·马蒙托夫", "科兹马·索尔达滕科夫"],
    correct: 1,
    explain: "伊利亚·列宾于1883年绘制的帕维尔·特列季亚科夫的著名肖像。",
    link: { to: "/litsa#person-tretyakov", label: "帕维尔·特列季亚科夫" },
  },
  {
    kind: "single",
    ...
    options: ["萨瓦·莫罗佐夫", "谢尔盖·舒金", "阿列克谢·巴赫鲁申", "斯捷潘·利亚布申斯基"],
    correct: 0,
    explain:
      "萨瓦·莫罗佐夫于1898年将自己的资金投入到康斯坦丁·斯坦尼斯拉夫斯基和弗拉基米尔·涅米罗维奇-丹钦科的新剧院。",
  ...
  },
  {
    ...
    options: ["瓦尔瓦拉·莫罗佐娃", "玛格丽塔·莫罗佐娃", "玛丽亚·特尼舍娃", "赫里斯蒂娜·阿尔切夫斯卡娅"],
    correct: 2,
    explain: "玛丽亚·特尼舍娃公主在斯摩棱斯克附近的塔拉什基诺庄园建立了工作室、学校和俄罗斯艺术中心。",
    link: { to: "/litsa#person-tenisheva", label: "玛丽亚·特尼舍娃" },
  },
  {
    kind: "multi",
    id: "baku-patrons",
    ...
    correct: [0, 2, 3],
    explain:
      "塔吉耶夫、诺贝尔和纳吉耶夫是巴库石油时代的赞助人。西比里亚科夫与伊尔库茨克有关，布格罗夫与下诺夫哥罗德有关。",
  ...
  },
  {
    kind: "single",
    id: "demidov-prize",
    question: "谁设立了在19世纪支持俄罗斯科学的杰米多夫奖？",
    options: ["普罗科皮·杰米多夫", "阿纳托利·杰米多夫", "亚历山大·斯特罗加诺夫", "尼古拉·鲁缅采夫"],
    correct: 1,
    explain: "阿纳托利·杰米多夫于1832年设立了杰米多夫奖——这是革命前俄罗斯最负盛名的科学奖项。",
    link: { to: "/nasledie#legacy-demidov-prize", label: "遗产 — 杰米多夫奖" },
  },
  {
    kind: "single",
    id: "form-endowment",
    ...
    correct: 1,
    explain: "定向资本（捐赠基金）是根据 FZ-275 规则投资的长期基金。只有收益用于实现目标。",
...
export const LEVELS: QuizLevel[] = [
  {
    ...
    max: 4,
    title: "新手",
    text: "您刚刚开始您的「先驱报」之旅。前方是高尚事迹的完整编年史。请查看「字母表」和「编年史」，以掌握俄罗斯慈善事业的语言。",
    links: [
  ...
  },
  {
    ...
    max: 12,
    title: "守护者",
    text: "您是「先驱报」的细心读者。您不仅知道名字，还了解时代的背景。是时候选择您自己的参与之路了。",
    links: [
      { to: "/puti", label: "参与方式" },
