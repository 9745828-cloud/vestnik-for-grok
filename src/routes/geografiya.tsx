...
const CITY_COORDS: Record<string, [number, number]> = {
  ...
  "كراسنايا سلوبودا": [48.51, 41.36],
  "红镇": [48.51, 41.36],

  "Зихрон-Яаков": [34.95, 32.57],
  "Zikhron Ya'akov": [34.95, 32.57],
  "زخرون يعقوب": [34.95, 32.57],
  "济赫龙雅各布": [34.95, 32.57],
